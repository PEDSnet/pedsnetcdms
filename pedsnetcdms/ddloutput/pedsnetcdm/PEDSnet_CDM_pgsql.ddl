...
CREATE INDEX ix_organization_organization_source_value_place_of_serv_59cc ON organization (organization_source_value varchar_pattern_ops, place_of_service_source_value varchar_pattern_ops);
...
CREATE INDEX ix_death_person_id_death_type_concept_id_cause_of_death_50e7 ON death (person_id, death_type_concept_id, cause_of_death_concept_id);
