...
CREATE INDEX ix_drug_strength_drug_concept_id_ingredient_concept_id_v_523e ON drug_strength (drug_concept_id, ingredient_concept_id, valid_end_date);
...
CREATE INDEX ix_concept_relationship_concept_id_1_concept_id_2_relati_ec36 ON concept_relationship (concept_id_1, concept_id_2, relationship_id);
...
CREATE INDEX ix_source_to_concept_map_source_vocabulary_id_target_con_0d87 ON source_to_concept_map (source_vocabulary_id, target_concept_id, source_code, valid_end_date);
